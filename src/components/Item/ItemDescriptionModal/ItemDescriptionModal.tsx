...
//               О товаре
//             </h2>
//             <h2 className={styles.wrapper__container__header__h2}>О товаре</h2>
//             <h2 className={styles.wrapper__container__header__h2}>
//               Характеристики
//             </h2>
//             <h2 className={styles.wrapper__container__header__h2}>Видео</h2>
//           </div>
//           <button
//             onClick={func}
